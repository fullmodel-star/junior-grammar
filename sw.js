const C = "923_junior-grammar-icons-b57e8b3a6c";
const A = ["./index.html", "./rv2-core.js", "./manifest.json", "./ridgeline-ui.css", "./favicon.svg", "./icon-192.png", "./icon-512.png", "./icon-maskable-512.png", "./icon.svg", "./", "./apple-touch-icon.png"];
